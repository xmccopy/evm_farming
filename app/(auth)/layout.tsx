...
import { FaUserPlus, FaHome, FaEthereum } from "react-icons/fa";
                            ...
                            <div className="-mr-2 flex">
                                <div className="-mr-2 flex">
                                    ...
                                    >
                                        ...
                                        <svg
                                            className={`${isMobileMenuOpen ? 'hidden' : 'block'} text-white dark:text-[#000000] h-6 w-[30px] relative z-50`}
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            strokeWidth="2"
                                            stroke="currentColor"
                                        ...
                                        <svg
                                            className={`${isMobileMenuOpen ? 'block' : 'hidden'} text-white dark:text-[#000000] h-6 w-[30px]`}
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            strokeWidth="2"
                                            stroke="currentColor"
