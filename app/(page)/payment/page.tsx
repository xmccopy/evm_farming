    ...
    return (
        <div className="mx-auto  text-white dark:text-[#000000] rounded-[24px] w-full shadow-lg">
            <div className='bg-[#2F2F8A] bg-opacity-80 w-full p-6 rounded-t-[24px] border-2 border-[#3333a5] rounded-tr-[24px]'>
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center">
                        <span className='w-[45px] h-[45px] text-[10px] bg-[#D9D9D9] dark:bg-gray-500 flex justify-center items-center text-black dark:text-[#ffffff] text-center'>シンボル<br />ロゴ</span>
                    </div>
                    <div className="flex items-center h-full gap-2">
                        <div className='flex rounded-full  p-2 gap-2 bg-[#1C1C65] dark:bg-[#c3c3ff] justify-center items-center'>
                            <span className='w-[25px] h-[25px] text-[5px] text-black dark:text-[#ffffff] flex justify-center items-center text-center bg-[#D9D9D9] dark:bg-gray-500'>シンボル<br />ロゴ</span>
                            <span className="text-[16px]">+ 0.001</span>
                            <span className="w-[15px] h-[15px]"><BsFillQuestionCircleFill /></span>
                        </div>
                        <span className='w-[41px] h-[41px] p-2 bg-[#1C1C65] dark:bg-[#7476ff] rounded-full flex justify-center items-center'>
                ...
                <div className="mb-6">
                    <div className="text-[32px] font-bold mb-4 flex gap-3">
                        <span>10.00 TRX</span>
                        <span className='w-[49px] h-[49px] bg-white dark:bg-[#7476ff] rounded-full flex justify-center items-center'><PiCopy className='text-[#2E1367] dark:text-[#ffffff] w-[20px] h-[20px]' /></span>
                    </div>
                    ...
                    <div className=" flex items-center">
                        ...
                        <div className='text-[16px] ml-3'>
                            <div className='text-white dark:text-[#000000]'>有効期限</div>
            ...
            <div className="px-6 pt-3 border-2 border-[#3333a5] rounded-br-[24px] rounded-b-[24px]">
                <div className="mb-4">
                    <select className="w-full p-6 text-white rounded-lg dark:text-[#000000] bg-white bg-opacity-0 border-2 border-[#252586]">
                ...
                <button className="mb-4 flex w-full rounded-xl gap-3 justify-center items-center py-4 border-2 border-[#252586] bg-white">
                ...
                <div className="flex items-center justify-center mb-4 gap-3">
                    <svg width="35%" height="2" viewBox="0 0 144 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line y1="0.552002" x2="144" y2="0.552002" stroke="black" stroke-opacity="0.6" />
                    </svg>
                    <span>または</span>
                    <svg width="35%" height="2" viewBox="0 0 144 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line y1="0.552002" x2="144" y2="0.552002" stroke="black" stroke-opacity="0.6" />
                ...
                <button className="mb-4 flex w-full text-[#1C1C65] border-2 border-[#252586] rounded-xl gap-3 justify-center items-center py-4 bg-white">
